        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div className="relative group">
              ...
              {/* Dropdown Menu */}
              <div className={`absolute right-0 top-full mt-3 w-52 backdrop-blur-2xl border rounded-2xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 ${
                theme === 'light'
