          ...
          <section>
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="border border-gray-200 rounded-lg p-3 sm:p-4">
                <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">👤 Account Information</h3>
              ...
              <div className="border border-gray-200 rounded-lg p-3 sm:p-4">
                <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">📚 Content Data</h3>
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-xs sm:text-sm">
              ...
              <div className="border border-gray-200 rounded-lg p-3 sm:p-4">
                <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">⚙️ Usage Data</h3>
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-xs sm:text-sm">
